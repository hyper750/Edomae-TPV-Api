...
from settings import IVA, TICKET_COMMAND_TEMPLATE_NAME, TIMEZONE
...
class TableTicket(AbstractTicket):

    def can_generate_ticket(self, id: int) -> bool:
        command: Command = Command.query.get(id)
        return not command.is_home_delivery

    def get_template_name(self) -> str:
        return TICKET_COMMAND_TEMPLATE_NAME
